...
def ler_xmls_na_pasta(caminho_pasta):
    ...
    return df, erros, sucessos, arquivos_erro
...
#caminho_pasta_0124 = 'Z:/Rafaella/Notas_Fiscais/SaoPaulo2024/entrada 01-2024'

# Chamando a função para ler os XMLs e gerar a tabela
#data_frame = ler_xmls_na_pasta(caminho_pasta_0124)
df_sucessos, erros, sucessos, arquivos_erro = ler_xmls_na_pasta(caminho_pasta)

# Salvando o DataFrame em um arquivo CSV
#data_frame.to_excel('tabela_nfs_02.xlsx', index=False, engine='openpyxl')
print(f"Erros: {erros}")
...
# df_erro.to_excel("arquivos_erro_0124.xlsx", index=False, engine='openpyxl')
